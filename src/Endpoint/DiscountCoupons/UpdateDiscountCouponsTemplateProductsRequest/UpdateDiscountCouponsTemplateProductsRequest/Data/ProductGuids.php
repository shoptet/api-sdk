...
namespace Shoptet\Api\Sdk\Php\Endpoint\DiscountCoupons\UpdateDiscountCouponsTemplateProductsRequest\UpdateDiscountCouponsTemplateProductsRequest\Data;
 ...
 */
class ProductGuids extends EntityCollection
{
    /**
     * @param mixed $data
