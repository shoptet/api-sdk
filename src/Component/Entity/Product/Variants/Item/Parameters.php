...
use Shoptet\Api\Sdk\Php\Component\Entity\Product\Variants\Item\Parameters\Item;
...
class Parameters extends EntityCollection
{
    ...
    {
        return 'Shoptet\Api\Sdk\Php\Component\Entity\Product\Variants\Item\Parameters\Item';
    }
}
