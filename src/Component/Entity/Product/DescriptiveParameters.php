...
use Shoptet\Api\Sdk\Php\Component\Entity\Product\DescriptiveParameters\Item;
...
class DescriptiveParameters extends EntityCollection
{
    ...
    {
        return 'Shoptet\Api\Sdk\Php\Component\Entity\Product\DescriptiveParameters\Item';
    }
}
