...
use Shoptet\Api\Sdk\Php\Component\Entity\ProofPaymentVatBreakdown\Items\Item;
...
class Items extends EntityCollection
{
    ...
    {
        return 'Shoptet\Api\Sdk\Php\Component\Entity\ProofPaymentVatBreakdown\Items\Item';
    }
}
