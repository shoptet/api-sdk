...
namespace Shoptet\Api\Sdk\Php\Component\Entity\CategoryProductPriorityBatchUpdate;

use Shoptet\Api\Sdk\Php\Component\Entity\CategoryProductPriorityBatchUpdate\Data\Item1;
use Shoptet\Api\Sdk\Php\Component\Entity\CategoryProductPriorityBatchUpdate\Data\Item2;
...
class Data extends EntityCollection
{
    ...
    {
        return $this->determineMultiTypeByData('Shoptet\Api\Sdk\Php\Component\Entity\CategoryProductPriorityBatchUpdate\Data\Item1|Shoptet\Api\Sdk\Php\Component\Entity\CategoryProductPriorityBatchUpdate\Data\Item2', $data);
    }
}
